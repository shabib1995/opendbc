...
class CAR(Platforms):
  ...
  HYUNDAI_PLATFORMS[CAR.GENESIS_GV80_2020] = HyundaiPlatformConfig(
    car_docs=[
     HyundaiCarDocs(
       "Genesis GV80 2020–2021 (JX1, CAN)",
       "All",
       car_parts=CarParts.common([CarHarness.hyundai_m]),
    )
    ],
    specs=CarSpecs(mass=2250,wheelbase=2.95,steerRatio=14.14,   # Here's Musaab Code change.
   ),
    flags=HyundaiFlags.CAN | HyundaiFlags.RADAR_SCC,
  )
